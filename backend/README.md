...
## Project Structure
    ...
    ├── weathered_butterfly_29225  # Django project configurations
...
1. Clone this repo and `cd weathered_butterfly_29225`
...
2. Clone this repo and `cd weathered_butterfly_29225`
